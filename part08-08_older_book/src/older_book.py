...
def older_book(book1:Book , book2 : Book):
    ...
    elif book2.year < book1.year: print(f'{book2.name} is older, it was published in {book2.year}')
    else:print(f'{book1.name} and {book2.name} were published in {book1.year}')
